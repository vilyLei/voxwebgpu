...
// 		this.z = z;
// 	}
// 	setAngRadAndNV(pang:number, nv:Vector3):void
// 	{
...
// 	}
// 	setRotRadAndNV(prad:number, nv:Vector3):void
// 	{
// 		this.m_rad = prad;
// 		this.m_cos = Math.cos(0.5 * this.m_rad);
// 		this.m_sin = Math.sin(0.5 * this.m_rad);
...
// 	}
// 	/**
// 	 * 四元数乘以3D矢量 Vector3,实现四元数对一个顶点的旋转
// 	 * @param				q		一个四元数对象
// 	 * @param				v		一个 3D矢量 Vector3
// 	 * @param				outV	计算结果存放于一个 Vector3 中
// 	 * */
// 	static quatMulV3(q:Quaternion, v:Vector3, outV:Vector3 ):void
// 	{
...
// 		outV.z = tz * 2.0;
// 	}
// 	rotate(q:Quaternion, v:Vector3):void
// 	{
