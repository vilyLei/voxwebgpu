(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ModuleCTMGeomParser"] = factory();
	else
		root["ModuleCTMGeomParser"] = factory();
...
class Decoder {
  ...
  setDecoderProperties(properties) {
    let value, lc, lp, pb, dictionarySize; // if (properties.size < 5) {
    //     return false;
    // }
...
class CTMDataParser extends BaseTaskInThread_1.BaseTaskInThread {
  ...
  parseMeshData(rdata, dataBuf) {
    ...
    try {
      ...
      console.log("ctm decode lossTime: ", Date.now() - losstime); // const readerBuf = new FileReader();
      // readerBuf.onload = (e) => {
